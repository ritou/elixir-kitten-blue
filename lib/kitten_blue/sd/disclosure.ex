defmodule KittenBlue.SD.Disclosure do
  ...
  def new(claim_name, claim_value, _salt) when is_nil(claim_name) or is_nil(claim_value) do
    raise ArgumentError, "claim_name and claim_value cannot be nil"
  end

  def new(claim_name, claim_value, salt) do
    salt = salt || :crypto.strong_rand_bytes(16) |> Base.url_encode64(padding: false)
